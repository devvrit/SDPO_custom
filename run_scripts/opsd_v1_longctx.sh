...
# Usage: ./run_scripts/opsd_v1_longctx.sh [experiment_name_suffix]
#
# OPSD v1 long-context experiment:
#   - Dataset: OpenThoughts-114k (v1, deepseek_solution as reference)
...
#   - GPU_MEMORY_UTILIZATION=0.55 (larger KV cache needed)
#   - Everything else same as repro10 (full-vocab JSD, alpha=0.5, LoRA 64/128)
...
echo "----------------------------------------------------------------"
echo "Starting OPSD v1 Long-Context Training"
echo "Experiment: $EXP_NAME"
echo "Data: $DATA_PATH (v1 OpenThoughts-114k)"
