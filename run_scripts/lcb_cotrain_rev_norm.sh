...
# Usage: ./run_scripts/lcb_cotrain_rev.sh [experiment_name_suffix]
...
#
# Like lcb.sh but enables teacher-context RL loss (teacher_rl_loss_coef)
...
echo "----------------------------------------------------------------"
echo "Starting SDPO + Teacher RL Co-Training (LCB)"
